// @ts-nocheck
// src/components/ThreeBackgrounds/PixelBlast.jsx
// Component inspired by github.com/zavalit/bayer-dithering-webgl-demo
// Adapted from react-bits PixelBlast
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const uniforms = {
        ...
        uShapeType: { value: SHAPE_MAP[variant] ?? 3 },
      ...
      // Use document-level listeners so clicks/hovers work even though canvas is behind content (zIndex: -1)
      ...
      const t = threeRef.current;
      t.uniforms.uShapeType.value = SHAPE_MAP[variant] ?? 3;
    ...
    liquid, pixelSize, patternScale, patternDensity,
    enableRipples, rippleIntensityScale, rippleThickness, rippleSpeed,
    pixelSizeJitter, edgeFade, liquidStrength, liquidRadius,
    liquidWobbleSpeed, variant, color, speed
  ]);
